...
$(document).ready(function() {
	...
	var config = {
		sensitivity: 3,
		interval: 300,
		over: function() { $(".menu_col").slideDown("800"); $("#main").animate({top: "+=28%"}, 350); $("#footer").animate({top: "+=28%"}, 350); },
		timeout: 150,
		out: function() { $(".menu_col").slideUp("800"); $("#main").animate({top: "-=28%"}, 350); $("#footer").animate({top: "-=28%"}, 350); },
	};
